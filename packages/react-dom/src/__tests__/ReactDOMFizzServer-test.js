...
`
  ...
  describe('text separators', () => {
    ...
    it('should not insert separators for text inside Suspense boundaries even if they would otherwise be considered text-embedded', async () => {
      ...
      expect(document.getElementById('app-div').outerHTML).toEqual(
        '<div id="app-div">start<!--$?--><template id="B:0"></template><!--?start name="B:0"-->[loading first]<!--?end--><!--/$--><!--$?--><template id="B:1"></template><!--?start name="B:1"-->[loading second]<!--?end--><!--/$-->end</div>',
      );
      ...
      expect(document.getElementById('app-div').outerHTML).toEqual(
        '<div id="app-div">start<!--$-->firststartfirst suspendedfirstend<!--/$--><!--$?--><template id="B:1"></template><!--?start name="B:1"-->[loading second]<!--?end--><!--/$-->end</div>',
      );
